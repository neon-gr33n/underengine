...
.add("gamepad face south",         spr_gamepad_ps5_small_cross)
.add("gamepad face east",          spr_gamepad_ps5_small_circle)
.add("gamepad face west",           spr_gamepad_ps5_small_square)
.add("gamepad face north",         spr_gamepad_ps5_small_triangle)
.add("gamepad shoulder l",          spr_gamepad_ps5_small_l1)
.add("gamepad shoulder r",         spr_gamepad_ps5_small_r1)
.add("gamepad trigger l",          spr_gamepad_ps5_small_l2)
.add("gamepad trigger r",          spr_gamepad_ps5_small_r2)
.add("gamepad select",             "create")
.add("gamepad start",              spr_gamepad_ps5_small_menu)
.add("gamepad dpad left",          spr_gamepad_xbox_small_dpad_left)
.add("gamepad dpad right",         spr_gamepad_xbox_small_dpad_right)
.add("gamepad dpad up",            spr_gamepad_xbox_small_dpad_up)
.add("gamepad dpad down",          spr_gamepad_xbox_small_dpad_down)
